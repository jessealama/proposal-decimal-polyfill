...
describe("notEquals", () => {
    ...
    test("simple example", () => {
        expect(
            new Decimal("123.456789").notEquals(new Decimal("123.456789"))
        ).toStrictEqual(false);
    });
    test("non-example", () => {
        expect(
            new Decimal("987.123").notEquals(new Decimal("123.456789"))
        ).toStrictEqual(true);
    });
    test("limit of significant digits", () => {
        expect(
            new Decimal("0.4166666666666666666666666666666667").notEquals(
    ...
    test("beyond limit of significant digits", () => {
        expect(
            new Decimal("0.41666666666666666666666666666666667").notEquals(
                new Decimal("0.41666666666666666666666666666666666")
            )
        ).toStrictEqual(false);
    });
