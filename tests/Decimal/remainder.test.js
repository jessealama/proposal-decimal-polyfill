    ...
    describe("edge cases for Decimal128 limits", () => {
        describe("remainder with extreme values", () => {
            ...
            test("very small value remainder normal value", () => {
                ...
                expect(tiny.remainder(normal).toString()).toStrictEqual("1e-6143");
            });
            
            test("negative extreme remainder", () => {
                const negMax = new Decimal("-9.999999999999999999999999999999999E+6144");
        ...
        describe("remainder preserving precision", () => {
            test("remainder with maximum significant digits", () => {
                ...
                expect(result.toString()).toStrictEqual("3.4567890123456789012345678901234e+5998");
            });
            ...
            test("remainder of values with extreme exponent difference", () => {
                ...
                expect(huge.remainder(small).toString()).toStrictEqual("1e+6143");
            });
        });
        ...
        describe("special remainder patterns", () => {
            test("remainder with value close to divisor", () => {
                const val = new Decimal("9.999999999999999999999999999999999E+6144");
                const divisor = new Decimal("9.999999999999999999999999999999998E+6144");
                // val % divisor = 1E+6111
                expect(val.remainder(divisor).toString()).toStrictEqual("1e+6111");
            });
